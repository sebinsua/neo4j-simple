...
The library provides nodes and relationships in [the form of promises](https://github.com/normalize/native-or-bluebird) (Bluebird promises are used if the library is installed otherwise we fallback to ES6 Promises) and is implemented on top of [Cypher queries](http://neo4j.com/developer/cypher-query-language/). Additionally *optionally* you can restrict database access through usage of [Joi](https://github.com/hapijs/joi) validators.
